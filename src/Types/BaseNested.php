 ...
 *   
 *   $TypeNested = $table->type('BaseNested');
 *
 * 	 参数表:
 * 	 
 *   $TypeNested = $table->type('BaseNested',[
...
class BaseNested extends Type {
	...
	function __construct( $data = array(), $option=array() ) {
		...
		$opts['placeholder'] = (isset($opts['placeholder']))? $opts['placeholder'] : 'SuperTable BaseNested (Array)';
